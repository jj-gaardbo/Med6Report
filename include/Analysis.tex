...
\section{Behavior change}
    ...
    A transformational game is a game that is designed with the intention of changing players with experiences that carry over into the real world\cite{transformationalFramework}. \todo{Maybe we don't need this section. If we're not making a game}
    ...
    % Conclude with intermixing as a choice
